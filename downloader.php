...
$singlefiles = array(
	array('https://raw.githubusercontent.com/arshaw/fullcalendar/master/lang/{!language!}.js', 'lang_fullcalendar'),
);
...
foreach($languages as $mylang2){
	...
	foreach($singlefiles as $slangparams){
		$file = fopen('data/'.$mylang2.'/'.$slangparams[1].'.js','w');
